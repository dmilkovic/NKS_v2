...
namespace SimpleWebBrowser
{
    ...
    public class WebBrowserHandTracker : MonoBehaviour
    {
        ...
        private void NuitrackManager_onNewGesture(nuitrack.Gesture gesture)
        {
            ...
            else if (gesture.Type == nuitrack.GestureType.GestureSwipeDown)
            {
                Debug.Log("Ovo je scroll dolje");
            ...
            } else if (gesture.Type == nuitrack.GestureType.GestureSwipeLeft)
            {
                Debug.Log("Ovo je scroll L");
            }
            else if (gesture.Type == nuitrack.GestureType.GestureSwipeRight)
            {
                Debug.Log("Ovo je scroll desno");
            }
